...
// mysql server should be ran on the background to check all detais
...
public class InstructorDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email","Class X(GPA)", "Class XII(GPA)", "Expertise","Education"};
